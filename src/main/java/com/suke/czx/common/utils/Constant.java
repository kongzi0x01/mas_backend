...
public class Constant {
    ...
    public static final String NUMBER_CODE_KEY = "mas:number:code:";
    public static final String MOBILE_CODE_KEY = "mas:mobile:code:";
    public static final String AUTHENTICATION_TOKEN = "mas:token:";

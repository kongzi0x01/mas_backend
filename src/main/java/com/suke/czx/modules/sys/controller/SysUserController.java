...
import com.suke.czx.modules.sys.config.MasProperties;
...
public class SysUserController extends AbstractController {
    ...
    public String upload(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            File destFile = new File(masProperties.getUploadDir() + filename);
            if (!destFile.exists()) {
                destFile.mkdirs();
            }
            file.transferTo(Paths.get(masProperties.getUploadDir() + filename));
